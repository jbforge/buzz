...
export const KIND_STREAM_MESSAGE_HTML = 40010;
...
export const CHANNEL_EVENT_KINDS = [
  ...
  KIND_STREAM_MESSAGE_HTML, // 40010 — HTML artifact embeds
...
// message still applies. NOTE: kind:40008 (diff) and kind:40010 (HTML embed)
...
export const CHANNEL_TIMELINE_CONTENT_KINDS = [
  ...
  KIND_STREAM_MESSAGE_HTML, // 40010 — HTML artifact embeds (own row)
